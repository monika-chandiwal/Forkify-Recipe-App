...
// Example usage of the timeout function with async/await
async function fetchRecipe() {
    try {
        // Simulating an API request with timeout
        await timeout(1); // 3 seconds timeout
        console.log('Request completed');
    } catch (error) {
        console.error(error); // This will catch the timeout error after 3 seconds
    }
}
//fetchRecipe();
...
},{"url:../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21"}],"loVOp":[function(require,module,exports,__globalThis) {
